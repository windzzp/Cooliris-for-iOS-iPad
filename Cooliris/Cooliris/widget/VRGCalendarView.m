...
@synthesize kVRGCalendarViewWidth;
@synthesize kVRGCalendarViewDayHeight;
@synthesize kVRGCalendarViewDayWidth;
...
- (void)selectDate:(int)date
{
    ...
    /*****************/
    /*Add to change timezone*/
    NSInteger interval = [[NSTimeZone systemTimeZone] secondsFromGMTForDate:selectedDate];
    self.selectedDate = [selectedDate dateByAddingTimeInterval:interval];
    /*****************/
...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        /*here you can change the position of the number in vertical,just change the value of targetY+10 */
    ...
    for (int i = 0; i<[self.markedDates count]; i++) {
        ...
        /***********/
        /*hide the black line under 1 and 5*/
...
- (id)init
{
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        self.kVRGCalendarViewDayHeight = 35;
        self.kVRGCalendarViewDayWidth = 44;
        self.kVRGCalendarViewWidth = 320 ;
    } else {
        self.kVRGCalendarViewDayHeight = 100;
        self.kVRGCalendarViewDayWidth = 108;
        self.kVRGCalendarViewWidth = 768;
    }
...
{
    self.kVRGCalendarViewDayHeight = dayHeight;
    self.kVRGCalendarViewDayWidth = dayWidth;
    [self setNeedsDisplay];
}
